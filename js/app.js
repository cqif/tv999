...
async function showDetails(id, vod_name, sourceCode) {
    ...
    try {
        ...
        const sourceName = data.videoInfo && data.videoInfo.source_name ? ` <span class="text-sm font-normal text-gray-400">(${data.videoInfo.source_name})</span>` : '';
